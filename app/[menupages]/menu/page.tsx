  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-md mx-auto bg-white min-h-screen shadow-lg relative flex flex-col">
        ...
        {/* Cart Bottom Bar - Fixed at bottom, always visible when there are items */}
        {uniqueItemsCount > 0 && (
          <div className="fixed bottom-0 left-0 right-0 max-w-md mx-auto bg-white border-t shadow-lg z-20">
            <div className="p-4">
