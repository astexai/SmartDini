            ...
            <div className="flex-1 space-y-4">
              ...
              <div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  {/* Add Category Button - Professional Minimal Design */}
                  {!showAddCategory ? (
                    <button
                      type="button"
                      onClick={() => setShowAddCategory(true)}
                      className="flex items-center gap-2 px-4 py-3 bg-white border border-gray-200 rounded-lg text-sm font-medium text-gray-600 hover:text-[#D92632] hover:border-[#D92632] hover:bg-red-50 transition-all whitespace-nowrap"
                    >
                      <Plus size={18} className="text-gray-400 group-hover:text-[#D92632]" />
                    ...
                    <div className="flex-1 flex items-center gap-2 animate-fadeIn">
                      <div className="relative flex-1">
                        ...
                        <input
                          ...
                          className="w-full bg-white border border-gray-200 rounded-lg pl-9 pr-3 py-3 text-sm font-medium outline-none focus:border-[#D92632] focus:ring-1 focus:ring-[#D92632] transition-all"
                          autoFocus
                      ...
                      <button
                        ...
                        className="px-4 py-3 bg-[#10B981] hover:bg-[#059669] text-white rounded-lg text-sm font-bold transition-colors disabled:opacity-50 disabled:cursor-not-allowed whitespace-nowrap"
                      >
                        Add
                      </button>
                      <button
                        ...
                        className="px-4 py-3 bg-white border border-gray-200 hover:bg-gray-50 text-gray-600 rounded-lg text-sm font-medium transition-colors whitespace-nowrap"
                      >
                        Cancel
                      </button>
                    </div>
              ...
              <div className="flex justify-end pt-2">
                <button
                  ...
                  className="bg-[#10B981] hover:bg-[#059669] text-white px-8 py-2.5 rounded-lg text-sm font-bold shadow-md transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                >
                  Save Item
                </button>
              </div>
                  ...
                  >
                    ...
                    <td className="py-3 px-6 text-center">
                      {item.editing ? (
                        ...
                        <span className="inline-flex items-center gap-1 px-3 py-1 rounded-full bg-gray-100 text-xs font-bold text-gray-600">
                          <Tag size={10} />
                          {item.category}
                        </span>
                      )}
